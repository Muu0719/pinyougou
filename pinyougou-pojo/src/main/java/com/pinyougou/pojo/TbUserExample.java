...
public class TbUserExample {
    ...
    public static class Criterion {
        private String condition;//SQL语句
        			   
        private Object value;//值

        private Object secondValue;//第二个参数

        private boolean noValue;//没有值标志

        private boolean singleValue;//单个参数标志

        private boolean betweenValue;//在什么之间的标志

        private boolean listValue;//集合参数标志
