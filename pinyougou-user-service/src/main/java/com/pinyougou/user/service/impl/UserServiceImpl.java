...
//				client.post();
		...
		@Override
		public boolean checkSmsCode(String phone, Long code) {
			Long redis_code = (Long) redisTemplate.boundHashOps("SmsCode").get(phone);
			if(code.longValue() == redis_code.longValue()){
				return true;
			}
			return false;
		}
